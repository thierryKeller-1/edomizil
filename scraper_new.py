...
class EdomizilScraper(object):
    ...
    def goto_page(self, url:str) -> str:
        ...
        try:
            ...
            # self.driver.wait_for_element("div[data-test='rental-sidebar']", wait=60)
            waiting_count = 0
    ...
    def soupify(self, element) -> object:
        return BeautifulSoup(element, 'lxml')

    def page_info_is_valid(self) -> bool:
        print('    =>  verifying page')
        info_container = self.driver.select("div[data-test='rental-sidebar']")
        info_cleaned = self.soupify(info_container.html())
